...
// Language selector: works with mouse, keyboard and touch. The links
// point to crawlable language URLs, so switching does not depend on JS.
(function(){
  var wrap = document.querySelector('.bm-lang');
  var btn = document.getElementById('bmLangButton');
  var panel = document.getElementById('bmLangPanel');
